...
RUN apk --update add apache2 openjdk8 php7 php7-apache2 curl php7-curl php7-json php7-openssl php7-simplexml php7-xml php7-gd php7-session php7-pdo_pgsql php7-mbstring
